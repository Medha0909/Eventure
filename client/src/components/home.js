...
function Home() {
  ...
  const navigateTo2 = () =>navigate('/participant');
        ...
        <tbody>
          ...
          <tbody>
            ...
            <td>
              ...
              <td>
              <img className="imgs" src="https://www.visionvivaah.com/blog/wp-content/uploads/2019/10/Best-Event-Management-Company-In-Mumbai-1200x675.jpg" alt="..." />
              </td>
            </tr>
            </tbody>
          </table>
